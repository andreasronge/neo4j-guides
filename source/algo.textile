...
* Neo4j comes with some graph algorithms included. Since Neo4j.rb simply wraps algorithms implemented in Java, they should have good performance.
...
The @Neo4j::Algo.all_paths@ and @Neo4j::Algo.all_path@ methods return an algorithm which can find all available paths between two nodes. 
