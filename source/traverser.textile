...
For cypher queries with lucene starting points you need the name of the index. 
<ruby>
class Person
...
You may get much better performance using cypher compared to using the Neo4j.rb traversals since it is executed in Java. Notice cypher support is available from neo4j.rb version >= 1.7
