...
*Array Gotchas 1* all items in an array must be of the same type.
*Array Gotchas 2* you can not change one item in the array (they are mutable), you have to create a new array each time you add, remove, change one item.
