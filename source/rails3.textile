...
* ActiveModel::Dirty
* ActiveModel::Observing (git head or >= 1.2.2)
...
No, not yet. Read more about it here: "the identity map":http://guides.rubyonrails.org/3_1_release_notes.html#identity-map

h4. Why can't I update nested models: node.nested << x; node.nested.save ?

Because neo4j does not have an identity map, see above.
