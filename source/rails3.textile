...
TIP: Notice that you can use the  @Neo4j::Model@ in a standalone application or Sinatra application. It is also possible to use the @Neo4j::NodeMixin@ in a Rails application instead of the @Neo4j::Model@
...
See the http://github.com/benjackson/devise-neo4j

h4. will_pagenate

No support currently, you have to do it yourself.
