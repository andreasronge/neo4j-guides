...
*Only supported in upcoming 1.2.2 of neo4j.rb (or git head)*
Check the following example of how the Rails Observer works in neo4j.rb "Example":http://github.com/endeepak/neo4j-observers-example
...
Relationship of same class is assumed by default.  For relationships between different classes, see "Mapping nodes/relationships to Ruby classes":mapping.html#has_list
...
For multitenancy support check "this":http://neo4j.rubyforge.org/guides/configuration.html#multitenancy
