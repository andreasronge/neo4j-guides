...
The @new@ method does not create new node in the database (unlike  @Neo4j::NodeMixin#new) but instead behaves like ActiveRecord @new@ method. The node will be saved to the database when the @save@ method is called (just like ActiveRecord).
